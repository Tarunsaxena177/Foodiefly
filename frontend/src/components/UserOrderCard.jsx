...
//         <button
//           className="bg-[#4F46E5] hover:bg-[#E0E7FF] text-white px-4 py-2 rounded-lg text-sm"
...
function UserOrderCard({ data }) {
  ...
  if (!data) {
    console.warn("UserOrderCard: missing order data");
    return (
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      {Array.isArray(data?.shopOrders) && data.shopOrders.length > 0 ? (
        ...
        <p className="text-gray-500 text-sm">No shop orders available</p>
      )}
