      ...
      <div className="w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2 flex items-center gap-2 text-gray-800">
            <IoLocationSharp className="text-[#4F46E5]" /> Delivery Location
          </h2>
          <div className="flex gap-2 mb-3">
            <input
              type="text"
              className="flex-1 border border-gray-300 rounded-lg p-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#4F46E5]"
              placeholder="Enter Your Delivery Address.."
              value={addressInput}
              onChange={(e) => setAddressInput(e.target.value)}
            />
            <button
              className="bg-[#4F46E5] hover:bg-[#E0E7FF] text-white px-3 py-2 rounded-lg flex items-center justify-center"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div
              className={`flex items-center gap-3 rounded-xl border p-4 text-left transition ${
                paymentMethod === "cod"
                  ? "border-[#4F46E5] bg-orange-50 shadow"
        ...
        <section>
          ...
          <div className="rounded-xl border bg-gray-50 p-4 space-y-2">
            ...
            <div className="flex justify-between text-lg font-bold text-[#4F46E5] pt-2">
              <span>Total</span>
