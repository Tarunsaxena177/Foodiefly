      ...
      <div className="max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100">
        <div className="flex flex-col items-center mb-6">
          <div className="bg-orange-100 p-4 rounded-full mb-4">
            <FaUtensils className="text-[#4F46E5] w-16 h-16" />
          </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button
            className="w-full bg-[#4F46E5] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-violet-600 hover:shadow-lg transition-all duration-200 cursor-pointer"
            disabled={loading}
          >
