  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-right mb-4 cursor-pointer text-[#4F46E5] font-medium"
        ...
        <button
          className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#4F46E5] text-white hover:bg-[#4338CA] cursor-pointer`}
        ...
        >
          ...
          <span className="text-[#4F46E5]">Sign Up</span>
        </p>
      </div>
    </div>
  );
